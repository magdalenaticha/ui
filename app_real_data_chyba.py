...
@st.cache_data
def load_data():
    if not os.path.exists('petacc3-student_project.h5'):
        st.error("HDF5 file not found. Please make sure 'petacc3-student_project.h5' is in the same directory.")
        return None
    try:
        # Adjust the file path as needed
        df = pd.read_hdf('petacc3-student_project.h5')  # or whatever your file is named
